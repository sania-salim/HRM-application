...
import { getFirestore, getDoc, getDocs, collection, addDoc, query, where, doc } from "https://www.gstatic.com/firebasejs/10.4.0/firebase-firestore.js";
...
export { db, getDocs, getDoc, collection, addDoc, query, where, doc };
